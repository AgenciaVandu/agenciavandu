...
@endpush
<x-layouts.guest titulo="Desarrollo Web a la Medida y Páginas para Inmobiliarias" meta-description="Somos una agencia de desarrollo que utiliza la tecnología a tu favor para elevar la experiencia de atención a clientes y obtener leads de manera sostenida y eficiente.">
    <x-header>
        <x-slot name="header">

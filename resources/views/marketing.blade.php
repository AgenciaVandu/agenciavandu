@push ('estilos')
@vite(['resources/scss/app.scss', 'resources/scss/global.scss', 'resources/scss/servicios.scss', 'resources/scss/branding.scss', 'resources/js/app.js', 'resources/js/observer.js', 'resources/js/portafolio.js', 'resources/js/diseno.js' ])
@endpush
<x-layouts.guest titulo="Diseñamos y desarrollamos sitios web y aplicaciones" meta-description="Somos una agencia de desarrollo que utiliza la tecnología a tu favor para elevar la experiencia de atención a clientes y obtener leads de manera sostenida y eficiente.">
    ...
    <section class="intro">
        <div class="container text-center">
            <div class="intro_contenido1"></div>
        </div>
    </section>

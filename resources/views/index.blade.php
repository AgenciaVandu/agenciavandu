...
@endpush
<x-layouts.guest titulo="Agencia de SEO y GEO: Posicionamos tu Marca en Google y ChatGPT"
    meta-description="Agencia de marketing digital especializada en SEO, optimización y estrategias de IA en 2026, fotografía empresarial, fotografía de alimentos y desarrollo web">
    ...
    <section class="intro ">
        <div class="container">
            <div class="contenido">
                <p>Somos una agencia de diseño y desarrollo web estratégico que ayuda a las empresas en momentos clave,
                    nos enfocamos en lo esencial para desbloquear oportunidades significativas. Nuestras soluciones
                    eficientes generan resultados tangibles.</p>
            ...
            <div class="grid-contenido">
                <div class="web">
                    ...
                    <div class="web__contenido">
                        <h3>Diseño web</h3>
                        <a href="{{ route('servicios') }}">Ver más información <span><img
                                    src="{{ asset('img/arrow-3.svg') }}" class="arrow" width="10"
                                    alt=""></span></a>
                    </div>
                </div>
                <div class="fotografia">
                    ...
                    <div class="foto__contenido">
                        <h2>Fotografía</h2>
                        <a href="{{ route('audiovisuales') }}">Ver más información <span><img
                                    src="{{ asset('img/arrow-3.svg') }}" class="arrow" width="10"
                                    alt=""></span></a>
                    </div>
                </div>
                <div class="digital">
                    ...
                    <div class="digital__contenido">
                        ...
                        <a href="{{ route('multimedia') }}">Ver más información <span><img
                                    src="{{ asset('img/arrow-3.svg') }}" class="arrow" width="10"
                                    alt=""></span></a>
                    </div>
                </div>
                <div class="impresos">
                    ...
                    <div class="impresos__contenido">
                        ...
                        <a href="{{ route('construccion') }}">Ver más información <span><img
                                    src="{{ asset('img/arrow-3.svg') }}" class="arrow" width="10"
                                    alt=""></span></a>
                    </div>
                </div>
                <div class="frase">
                    <div class="frase__contenido">
                        <h6>¡Es un equipo maravilloso! Hemos trabajado juntos desde hace más de 4 años y siempre
                            terminamos satisfechos. 100% recomendados.</h6>
            ...
            <div class="row detalles">
                ...
                <div class="col-lg-4 col-12">
                    <p>
                        ...
                        Priorizamos la seguridad de tus movimientos, tu paso por el mundo digital será totalmente
                        placentero.
                    </p>
                </div>
            </div>
